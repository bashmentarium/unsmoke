  ...
  return (
    ...
    >
      ...
      <Text style={styles.privacyText}>
        Nicolai Voronin built the Unsmoke app as a Commercial app. This SERVICE
        is provided by Nicolai Voronin and is intended for use as is. This page
        is used to inform visitors regarding my policies with the collection,
        use, and disclosure of Personal Information if anyone decided to use my
        Service.
        {'\n'}
        If you choose to use my Service, then you agree to the collection and
        use of information in relation to this policy. The email address, diary entries, questionnaire answers
        that I collect are used for providing and improving the Service. I will
        not use or share your information with anyone except as described in
        this Privacy Policy. The terms used in this Privacy Policy have the same
        meanings as in our Terms and Conditions, which is accessible at Unsmoke
        unless otherwise defined in this Privacy Policy.
      </Text>
      <Text style={styles.privacyHeading}>Information Collection and Use</Text>
      <Text style={styles.privacyText}>
        For a better experience, while using our Service, I may require you to
        provide us with certain personally identifiable information, including
        but not limited to Email Adresses for user personalization. The
      ...
      <Text style={styles.privacyHeading}>Log Data</Text>
      <Text style={styles.privacyText}>
      ...
      <Text style={styles.privacyHeading}>Cookies </Text>
      <Text style={styles.privacyText}>
      ...
      <Text style={styles.privacyHeading}>Service Providers</Text>
      <Text style={styles.privacyText}>
      ...
      <Text style={styles.privacyHeading}>Security</Text>
      <Text style={styles.privacyText}>
      ...
      <Text style={styles.privacyHeading}>Links to Other Sites</Text>
      <Text style={styles.privacyText}>
      ...
      <Text style={styles.privacyHeading}>Children’s Privacy</Text>
      <Text style={styles.privacyText}>
      ...
      <Text style={styles.privacyHeading}>Changes to This Privacy Policy</Text>
      <Text style={styles.privacyText}>
        ...
        is effective as of 2020-05-18
      </Text>
      <Text style={styles.privacyHeading}>Contact Us</Text>
      <Text style={styles.privacyText}>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at unsmoke.app@gmail.com
      </Text>
      <View
        style={{
          ...styles.continue,
      ...
      >
        <Button
          ...
          buttonStyle={Platform.OS === 'ios' ? styles.buttonIos : styles.button}
