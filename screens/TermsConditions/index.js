  ...
  return (
    ...
    >
      ...
      <Text style={styles.privacyText}>
        ...
        still belong to Nicolai Voronin.
        {'\n'}Nicolai Voronin is committed to ensuring that the app is as useful
        ...
        {'\n'}The Unsmoke app stores and processes personal data that you have
        ...
        features and it could mean that the Unsmoke app won’t work properly or
        at all.
        ...
        by the app https://policies.google.com/terms
        {'\n'}You should be aware that there are certain things that Nicolai
        Voronin will not take responsibility for. Certain functions of the app
        ...
        but Nicolai Voronin cannot take responsibility for the app not working
        ...
        using the app.
        {'\n'}Along the same lines, Nicolai Voronin cannot always take
        ...
        turn it on to avail the Service, Nicolai Voronin cannot accept
        responsibility.
        {'\n'}With respect to Nicolai Voronin’s responsibility for your use of
        ...
        we can make it available to you. Nicolai Voronin accepts no liability
        for any loss, direct or indirect, you experience as a result of relying
        wholly on this functionality of the app.
        {'\n'}At some point, we may wish to update the app. The app is currently
        available on Android & IOS – the requirements for system(and for any
        ...
        using the app. Nicolai Voronin does not promise that it will always
        update the app so that it is relevant to you and/or works with the
        Android & IOS versions that you have installed on your device. However,
      ...
      <Text style={styles.privacyText}>
        ...
        do not hesitate to contact me at unsmoke.app@gmail.com
      </Text>
      <View
        style={{
          ...styles.continue,
